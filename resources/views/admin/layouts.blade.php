                ...
                <div class="mr-auto ">
                    <ul class="navbar-nav mr-3">
                        ...
                        <li><a href="/" class="nav-link nav-link-lg ">
                                <div class="judul-navbar active">RENTCON</div>
                            </a></li>
                    </ul>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="/" class="text-white">RENTCON</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="/" class="text-white">RNTCN</a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header">Data Barang</li>
                        <li class="{{ Route::is('barang.index') ? 'active' : '' }}"><a class="nav-link"
                                href="
                                    {{ route('barang.index') }}
                                    "><i
